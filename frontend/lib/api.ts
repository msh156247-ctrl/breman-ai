...
function stableMemberId(row: BackendMember, provider: APIProvider): string {
...
function workspaceAgentToAgent(row: Record<string, unknown>): Agent {
...
function memberToAgent(row: BackendMember): Agent {
