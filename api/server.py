...
from api.approval_notifications import (
    approval_notification_id as _approval_notification_id,
    approval_notification_payload,
    normalize_approval_channel as _normalize_approval_channel,
    normalize_approval_channels as _normalize_approval_channels,
    notification_row_from_event as _notification_row_from_event,
    retryable_approval_notifications as _select_retryable_approval_notifications,
)
...
def _approval_notification_payload(notification: Dict[str, Any]) -> Dict[str, Any]:
    return approval_notification_payload(notification, public_url=_approval_public_url)
...
def _retryable_approval_notifications(
    ...
    *,
    ...
    return _select_retryable_approval_notifications(
        rows,
        channels=channels,
